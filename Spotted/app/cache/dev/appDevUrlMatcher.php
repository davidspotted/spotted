...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/css/b931461')) {
            // _assetic_b931461
        ...
        // spotted_spots_homepage
        if (preg_match('#^/(?P<_locale>[^/]++)/home/?$#s', $pathinfo, $matches)) {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'spotted_spots_homepage');
            }

            return $this->mergeDefaults(array_replace($matches, array('_route' => 'spotted_spots_homepage')), array (  '_controller' => 'Spotted\\SpotsBundle\\Controller\\HomeController::indexAction',));
        }

        // spotted_user_login
        if (preg_match('#^/(?P<_locale>[^/]++)/?$#s', $pathinfo, $matches)) {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'spotted_user_login');
            }

            return $this->mergeDefaults(array_replace($matches, array('_route' => 'spotted_user_login')), array (  '_controller' => 'Spotted\\UserBundle\\Controller\\LoginController::indexAction',));
        }
